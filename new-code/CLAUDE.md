...
- **Lightbox** — Öffnet bei Klick auf `.mc`, `.dsgn-card`, `.ps-item`; unterstützt Bilder, lokale Videos und YouTube-Iframes
...
**Wichtig:** Der Click-Handler für Slideshow-Bilder liegt auf `.ps-item` (nicht auf `.ps-item img`), damit der Deeplink-Handler `.click()` direkt auf dem Div aufrufen kann und die Lightbox korrekt öffnet.
